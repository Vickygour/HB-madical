...
const Silvermat = () => {
  const [selectedImage, setSelectedImage] = useState(silvermat);

  const images = [silvermat, silvermat2];
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <p className="text-sm text-gray-500 mb-2">
              Model no . HB SILVER MAT 4000A
            </p>

            <h1 className="text-3xl font-semibold mb-4">HB SILVER MAT 4000A</h1>

            <ul className="list-disc pl-5 space-y-3 text-gray-700 mb-6">
              <li>Nano Ceramic Stones for better heat retention</li>
              <li>Double Layer Therapeutic Stones for effective pain relief</li>
              <li>Heating Therapy for muscle relaxation</li>
              <li>FIR (Far Infrared) Therapy for deep tissue comfort</li>
              <li>TENS Therapy for natural pain relief</li>
              <li>Compact Mini Design for targeted body areas</li>
              <li>Easy to Use & Portable for home, office, or travel</li>
            </ul>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16">
        ...
        <div className="mt-8 text-gray-700">
          <ul className="list-disc pl-6 space-y-3">
            <li>Helps relieve neck, back & muscle pain</li>
            <li>Improves blood circulation</li>
            <li>Reduces stiffness and muscle tension</li>
            <li>FIR therapy penetrates deep to relax muscles naturally</li>
            <li>Supports faster pain relief</li>
          </ul>
        </div>
      </div>
