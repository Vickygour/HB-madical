...
import goldmat2 from '../../assets/HB GOLD MAT.jpg';
import goldmat3 from '../../assets/02 HB GOLD MAT.jpg';
import goldmat4 from '../../assets/03 HB GOLD MAT.jpg';
import goldmat5 from '../../assets/04 HB GOLD MAT.jpg';
...
const Goldmat = () => {
  const [selectedImage, setSelectedImage] = useState(goldmat);

  const images = [goldmat, goldmat2, goldmat3, goldmat4, goldmat5];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <p className="text-sm text-gray-500 mb-2">
              1100 Nano Ceramic and Double Layer Stones mat
            </p>

            <h1 className="text-3xl font-semibold mb-4">
              HB Full Body Stones Heating Mat
            </h1>

            <ul className="list-disc pl-5 space-y-3 text-gray-700 mb-6">
              <li>
                Nano Ceramic Stones : for enhanced heat retention and therapy
                effect
              </li>
              <li>
                Double Layer Stones : with Germanium & Tourmaline for deeper
                pain relief
              </li>
              <li>6 Powerful PEMF Points for targeted body stimulation</li>
              <li>TENS Therapy to relax muscles and reduce pain naturally</li>
              <li>4-in-1 Therapy Mat – TENS, PEMF, Heating & FIR therapy</li>
              <li>Full Body Coverage Design for neck, back, waist & legs</li>
            </ul>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16">
        ...
        <div className="mt-8 text-gray-700">
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>Boost immunity system</li>
            <li>Effective for back pain and general body pain relief</li>
            <li>Reduce Body Fat</li>
            <li>Ideal for daily therapy and full body rejuvenation</li>
          </ul>
        </div>
      </div>
