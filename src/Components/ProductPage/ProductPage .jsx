...
import goldmat from '../../assets/02 HB GOLD MAT.jpg';
...
const ProductPage = () => {
  const [selectedImage, setSelectedImage] = useState(matMain);

  const images = [matMain, thumb1, thumb2,];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <h1 className="text-3xl font-semibold mb-4">
              HB Cervical Stones Heating Pillow
            </h1>

            <ul className="list-disc pl-5 space-y-3 text-gray-700 mb-6">
              <li>
                Nano Ceramic Stones : Enhances heat retention and improves
                therapeutic effect
              </li>
              <li>
                Double Layer Stones: Germanium & Tourmaline stones for deeper
                relaxation
              </li>
              <li>
                TENS & Heating Therapy: Dual therapy helps reduce pain and
                muscle stiffness
              </li>
              <li>
                Ergonomic Cervical Design: Supports neck, shoulders, and upper
                spine naturally
              </li>
              <li>
                Premium Build Quality: Durable, skin-friendly material for
                long-term use
              </li>
            </ul>
